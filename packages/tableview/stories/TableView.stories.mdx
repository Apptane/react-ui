...
import { MarginArgTypes, BoxBorderArgTypes, StateManager } from "@apptane/react-ui-storybook-docs";
  ...
  <StateManager initialValue={{ sortKey: "name", sortDir: "asc" }}>
    {({ state, setState }) => (
      <TableView
        ...
        <TableView.Column width={90} header="Age" alignment="right" sortKey="age">
